...
func TestIndexIncludesExplorerUI(t *testing.T) {
	...
	require.Contains(t, compactBody, "['PiOutputLogs',r.stdout_log_path||'']")
	require.Contains(t, compactBody, "['PiErrorLogs',r.stderr_log_path||'']")
	require.Contains(t, compactBody, "['PiEvents',r.pi_events_path||'']")
	...
	require.Less(t, strings.Index(compactBody, "['PiOutputLogs',r.stdout_log_path||'']"), strings.Index(compactBody, "['PiErrorLogs',r.stderr_log_path||'']"))
	require.Less(t, strings.Index(compactBody, "['PiErrorLogs',r.stderr_log_path||'']"), strings.Index(compactBody, "['PiEvents',r.pi_events_path||'']"))
