...
var frontendDevelopmentCriterionOwners = []FrontendDevelopmentCriterionOwner{
	...
	{ID: "frontend.AC-8", PrimaryOwner: "production.frontend-static", Command: "make -C mcp-gateway test-frontend-s6", Selectors: []string{"ui:verify-generated", "ui:verify-supply-chain", "TestS6StaticSupplyChain"}, SupportingOwners: []string{"production.browser-coordinator", "production.browser-workflows"}},
