...
func TestS6PlannedCommand(t *testing.T) {
	...
	assert.EqualError(t, ValidateS6OwnerForExecution("T14"), "S6 owner T14 is planned, not executable")
	assert.EqualError(t, ValidateS6OwnerForExecution("M3"), "S6 owner M3 is planned, not executable")
