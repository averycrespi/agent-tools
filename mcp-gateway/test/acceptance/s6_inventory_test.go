...
func TestS6PlannedCommand(t *testing.T) {
	...
	require.NoError(t, ValidateS6OwnerForExecution("T18"))
	require.NoError(t, ValidateS6OwnerForExecution("T19"))
	require.NoError(t, ValidateS6OwnerForExecution("T20"))
	require.NoError(t, ValidateS6OwnerForExecution("T21"))
	require.NoError(t, ValidateS6OwnerForExecution("T22"))
	require.NoError(t, ValidateS6OwnerForExecution("T23"))
	require.NoError(t, ValidateS6OwnerForExecution("T24"))
	require.NoError(t, ValidateS6OwnerForExecution("T25"))
	require.NoError(t, ValidateS6OwnerForExecution("T26"))
	require.NoError(t, ValidateS6OwnerForExecution("T27"))
	require.NoError(t, ValidateS6OwnerForExecution("T28"))
	require.NoError(t, ValidateS6OwnerForExecution("T29"))
	require.NoError(t, ValidateS6OwnerForExecution("T30"))
	require.NoError(t, ValidateS6OwnerForExecution("T31"))
	require.NoError(t, ValidateS6OwnerForExecution("T32"))
	require.NoError(t, ValidateS6OwnerForExecution("T33"))
	require.NoError(t, ValidateS6OwnerForExecution("T34"))
	require.NoError(t, ValidateS6OwnerForExecution("T35"))
	require.NoError(t, ValidateS6OwnerForExecution("T36"))
	require.NoError(t, ValidateS6OwnerForExecution("T37"))
	require.NoError(t, ValidateS6OwnerForExecution("T38"))
	require.NoError(t, ValidateS6OwnerForExecution("T39"))
	require.NoError(t, ValidateS6OwnerForExecution("T40"))
	require.NoError(t, ValidateS6OwnerForExecution("T41"))
	require.NoError(t, ValidateS6OwnerForExecution("T42"))
	require.NoError(t, ValidateS6OwnerForExecution("T43"))
	require.NoError(t, ValidateS6OwnerForExecution("T44"))
	require.NoError(t, ValidateS6OwnerForExecution("T45"))
	require.NoError(t, ValidateS6OwnerForExecution("T46"))
	require.NoError(t, ValidateS6OwnerForExecution("T47"))
	require.NoError(t, ValidateS6OwnerForExecution("T48"))
	require.NoError(t, ValidateS6OwnerForExecution("T49"))
	require.NoError(t, ValidateS6OwnerForExecution("T50"))
	require.NoError(t, ValidateS6OwnerForExecution("T51"))
	...
	require.NoError(t, ValidateS6OwnerForExecution("T57"))
	...
	require.NoError(t, ValidateS6OwnerForExecution("M4"))
	require.NoError(t, ValidateS6OwnerForExecution("M5"))
	require.NoError(t, ValidateS6OwnerForExecution("M6"))
	...
	assert.EqualError(t, ValidateS6OwnerForExecution("T58"), "S6 owner T58 is planned, not executable")
