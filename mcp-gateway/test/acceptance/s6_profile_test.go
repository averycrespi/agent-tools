...
func TestS6AcceptanceProfile(t *testing.T) {
	...
	t.Run("targets and qualifier are frozen", func(t *testing.T) {
		...
		assert.Equal(t, 1, countListedTests(t, moduleRoot, "e2e,browser", `^TestBrowserVisualResponsiveMatrix$`, "./test/e2e"))
		assert.Equal(t, 1, countListedTests(t, moduleRoot, "e2e,browser", `^TestBrowserAccessibility$`, "./test/e2e"))
		assert.Equal(t, 1, countListedTests(t, moduleRoot, "e2e,browser", `^TestBrowserCrossCompatibility$`, "./test/e2e"))
