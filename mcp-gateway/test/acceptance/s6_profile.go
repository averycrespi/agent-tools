...
func s6ProfileCommands() []Command {
	...
	metadata := map[string]s6CommandMetadata{
		...
		"browser_a11y":           {Criteria: []string{"AC-1", "AC-8"}, Evidence: []string{"browser-a11y"}, Artifacts: []string{"mcp-gateway/test/e2e/s6_accessibility_browser_test.go"}},
		...
		"security_privacy":       {Criteria: []string{"AC-2", "AC-5", "AC-6", "AC-10"}, Evidence: []string{"security-privacy", "privacy"}, Artifacts: []string{"mcp-gateway/test/security", "mcp-gateway/test/e2e/s6_privacy_browser_test.go"}},
