...
func ProfileCommands(profile Profile) ([]Command, error) {
	...
	case ProfileS4:
		return []Command{
			{CheckName: "contract_privacy_acceptance", Name: "go", Arguments: []string{"-C", "mcp-gateway", "test", "-race", "./internal/contract", "./internal/invocation", "./internal/storage", "./internal/composition", "./test/material", "./test/acceptance"}, Criteria: []string{"AC-1", "AC-2", "AC-3", "AC-4", "AC-5"}, Evidence: []string{"s4-contract", "s4-schema", "s4-redaction-fuzz", "s4-sanitizer-fuzz", "s4-source-guards", "s4-source-privacy", "s4-docs", "s4-acceptance"}, Artifacts: []string{"mcp-gateway/internal/contract/invocation_evidence_contract_test.go", "mcp-gateway/internal/storage/migrations/009_invocations.sql", "mcp-gateway/internal/invocation/redaction_test.go", "mcp-gateway/internal/invocation/result_test.go", "mcp-gateway/internal/composition/source_test.go", "mcp-gateway/test/material", "mcp-gateway/test/acceptance"}},
