...
var s6Selectors = map[string][]string{
	...
	"T36": {"TestS6BrowserBackups"}, "T37": {"TestS6BrowserCapabilityAudit"}, "T38": {"TestCLIServerCatalogReads"},
	...
	"M1": {"Test(SessionEventContractIntegration|AdminSessionShutdownInvalidatesBrowserSession|StaticShellSecurityHeaders|EventHubClosesWithBrowserSessionAndShutdown|BoundaryRoutesSessionAndEventAuthorities)", "TestS6BrowserM1Canary"}, "M2": {"Test(InvocationReadPaginationIntegration|InvocationReadCompositionIntegration)", "TestInvocationReadOnlyAPICanary"}, "M3": {"TestS6BrowserM3Canary"},
	"M4": {"TestCLIPrivateAuthorityBoundary", "TestCLIOnlineOfflineOutputCanary"}, "M5": {"TestS6BrowserM5Canary"}, "M6": {"TestS6BrowserM6Canary"},
	"M7": {"TestS6BrowserM7Canary"}, "M8": {"TestS6BrowserM8Canary"}, "M9": {"TestCLIServerLifecycleCanary"}, "M10": {"Test(CLISharedContract|ControlClientSharedContract)", "TestCLIAuthorityLifecycleCanary"},
