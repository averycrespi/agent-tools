...
var s5IntegrationPackages = []string{
	"./internal/storage", "./internal/backup", "./internal/servercredentials", "./internal/grantrequests",
	"./internal/authorization", "./internal/catalog", "./internal/invocation", "./internal/composition",
}
