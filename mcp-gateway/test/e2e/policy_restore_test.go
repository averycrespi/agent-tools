...
func TestGatewayBinaryRestoresPolicyWithoutRestoringAuthority(t *testing.T) {
	...
	assertDiscoveryPage(t, currentB, json.RawMessage(`"current-b"`), names[:100], discoveryCursor(t, currentB))
	...
	assertDiscoveryPage(t, currentC, json.RawMessage(`"current-c"`), names[:100], discoveryCursor(t, currentC))
