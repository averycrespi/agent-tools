...
func onlineCommandSpecs() []onlineCommandSpec {
	return []onlineCommandSpec{
		...
		onlineSpec([]string{"grant", "create"}, "create", "grant create --principal-id ID --effect EFFECT --server-id ID [--upstream-name NAME] [--expires-at RFC3339] [--file PATH]", "principal-id", "effect", "server-id", "upstream-name", "expires-at", "file"),
		...
		onlineSpec([]string{"grant-request", "approve"}, "approve REQUEST_ID", "grant-request approve REQUEST_ID --scope SCOPE --target TARGET [--etag ETAG] [--duration-seconds SECONDS] [--acknowledge-future-tools] [--file PATH]", "scope", "target", "etag", "duration-seconds", "acknowledge-future-tools", "file", "yes"),
...
var onlineLeafDescriptions = map[string]string{
	...
	"grant create --principal-id ID --effect EFFECT --server-id ID [--upstream-name NAME] [--expires-at RFC3339] [--file PATH]": "Create an authorization grant",
	...
	"grant-request approve REQUEST_ID --scope SCOPE --target TARGET [--etag ETAG] [--duration-seconds SECONDS] [--acknowledge-future-tools] [--file PATH]": "Approve an agent grant request",
