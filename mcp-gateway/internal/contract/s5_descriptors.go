...
const SyntheticCatalogRevision = "2"
...
var syntheticSelfServiceTools = []SyntheticSelfServiceTool{
	...
	newSyntheticTool(
		...
		json.RawMessage(`{"type":"object","additionalProperties":false,"required":["policy"],"properties":{"policy":{"type":"object","additionalProperties":false,"required":["scope","target","constraint","duration_seconds","future_tools_acknowledged"],"properties":{"scope":{"enum":["tool","server"]},"target":{"type":"string","minLength":1,"maxLength":128},"constraint":{"description":"Null, permanent v1 equality, or v2 equality and full-string RE2 constraint.","anyOf":[{"type":"null"},{"type":"object","additionalProperties":false,"required":["equals"],"properties":{"equals":{"type":"object","minProperties":1,"maxProperties":16,"propertyNames":{"type":"string","minLength":1,"maxLength":256},"additionalProperties":{"type":["string","boolean","number","null"]}}}},{"type":"object","additionalProperties":false,"required":["version"],"properties":{"version":{"const":2},"equals":{"type":"object","minProperties":1,"maxProperties":16,"propertyNames":{"type":"string","minLength":1,"maxLength":256},"additionalProperties":{"type":["string","boolean","number","null"]}},"regex":{"type":"object","description":"Full-string RE2 patterns.","minProperties":1,"maxProperties":16,"propertyNames":{"type":"string","minLength":1,"maxLength":256},"additionalProperties":{"type":"string","maxLength":1024}}},"anyOf":[{"required":["equals"]},{"required":["regex"]}],"allOf":[{"anyOf":[{"required":["equals"],"not":{"required":["regex"]}},{"required":["regex"],"not":{"required":["equals"]}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":1},"regex":{"maxProperties":15}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":2},"regex":{"maxProperties":14}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":3},"regex":{"maxProperties":13}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":4},"regex":{"maxProperties":12}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":5},"regex":{"maxProperties":11}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":6},"regex":{"maxProperties":10}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":7},"regex":{"maxProperties":9}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":8},"regex":{"maxProperties":8}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":9},"regex":{"maxProperties":7}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":10},"regex":{"maxProperties":6}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":11},"regex":{"maxProperties":5}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":12},"regex":{"maxProperties":4}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":13},"regex":{"maxProperties":3}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":14},"regex":{"maxProperties":2}}},{"required":["equals","regex"],"properties":{"equals":{"maxProperties":15},"regex":{"maxProperties":1}}}]}]}]},"duration_seconds":{"anyOf":[{"type":"null"},{"type":"string","pattern":"^(?:[6-9][0-9]|[1-9][0-9]{2,5}|[12][0-9]{6})$"}]},"future_tools_acknowledged":{"type":"boolean"}}}}}`), false, false, false,
		json.RawMessage(`{"annotations":{"destructiveHint":false,"idempotentHint":false,"openWorldHint":false,"readOnlyHint":false,"title":"Create grant request"},"description":"Create or return an identical pending access request for the authenticated principal.","inputSchema":{"additionalProperties":false,"properties":{"policy":{"additionalProperties":false,"properties":{"constraint":{"anyOf":[{"type":"null"},{"additionalProperties":false,"properties":{"equals":{"additionalProperties":{"type":["string","boolean","number","null"]},"maxProperties":16,"minProperties":1,"propertyNames":{"maxLength":256,"minLength":1,"type":"string"},"type":"object"}},"required":["equals"],"type":"object"},{"additionalProperties":false,"allOf":[{"anyOf":[{"not":{"required":["regex"]},"required":["equals"]},{"not":{"required":["equals"]},"required":["regex"]},{"properties":{"equals":{"maxProperties":1},"regex":{"maxProperties":15}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":2},"regex":{"maxProperties":14}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":3},"regex":{"maxProperties":13}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":4},"regex":{"maxProperties":12}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":5},"regex":{"maxProperties":11}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":6},"regex":{"maxProperties":10}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":7},"regex":{"maxProperties":9}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":8},"regex":{"maxProperties":8}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":9},"regex":{"maxProperties":7}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":10},"regex":{"maxProperties":6}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":11},"regex":{"maxProperties":5}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":12},"regex":{"maxProperties":4}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":13},"regex":{"maxProperties":3}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":14},"regex":{"maxProperties":2}},"required":["equals","regex"]},{"properties":{"equals":{"maxProperties":15},"regex":{"maxProperties":1}},"required":["equals","regex"]}]}],"anyOf":[{"required":["equals"]},{"required":["regex"]}],"properties":{"equals":{"additionalProperties":{"type":["string","boolean","number","null"]},"maxProperties":16,"minProperties":1,"propertyNames":{"maxLength":256,"minLength":1,"type":"string"},"type":"object"},"regex":{"additionalProperties":{"maxLength":1024,"type":"string"},"description":"Full-string RE2 patterns.","maxProperties":16,"minProperties":1,"propertyNames":{"maxLength":256,"minLength":1,"type":"string"},"type":"object"},"version":{"const":2}},"required":["version"],"type":"object"}],"description":"Null, permanent v1 equality, or v2 equality and full-string RE2 constraint."},"duration_seconds":{"anyOf":[{"type":"null"},{"pattern":"^(?:[6-9][0-9]|[1-9][0-9]{2,5}|[12][0-9]{6})$","type":"string"}]},"future_tools_acknowledged":{"type":"boolean"},"scope":{"enum":["tool","server"]},"target":{"maxLength":128,"minLength":1,"type":"string"}},"required":["scope","target","constraint","duration_seconds","future_tools_acknowledged"],"type":"object"}},"required":["policy"],"type":"object"},"name":"create_grant_request","title":"Create grant request"}`),
		"186750525ae946fb8633553c2405a469e462ac1c03a6c5d93088029140e5573a",
	),
	newSyntheticTool(
