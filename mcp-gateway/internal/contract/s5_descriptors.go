...
const SyntheticCatalogRevision = "4"
...
var syntheticSelfServiceTools = []SyntheticSelfServiceTool{
	...
	newSyntheticTool(
		...
		json.RawMessage(`{"type":"object","additionalProperties":false,"required":["policy"],"properties":{"policy":{"type":"object","additionalProperties":false,"required":["scope","target","constraint","duration_seconds","future_tools_acknowledged"],"properties":{"scope":{"enum":["tool","server"]},"target":{"type":"string","minLength":1,"maxLength":128},"constraint":{"description":"Null, permanent v1 equality, or v2 equality and full-string RE2 constraint. The production compiler additionally enforces an 8192-byte aggregate, RFC 6901 escapes, RE2 validity, at most 4096 instructions per pattern, and at most 256 instructions across regex atoms.","anyOf":[{"type":"null"},{"type":"object","additionalProperties":false,"required":["equals"],"properties":{"equals":{"type":"object","minProperties":1,"maxProperties":16,"propertyNames":{"type":"string","minLength":1,"maxLength":64,"pattern":"^(?:/(?:[^~/]|~[01])*)+$","description":"JSON Pointer. Schema conservatively caps 64 Unicode characters; production permits at most 256 UTF-8 bytes."},"additionalProperties":{"type":["string","boolean","number","null"]}}}},{"type":"object","additionalProperties":false,"required":["version"],"properties":{"version":{"const":2},"equals":{"type":"object","maxProperties":16,"propertyNames":{"type":"string","minLength":1,"maxLength":64,"pattern":"^(?:/(?:[^~/]|~[01])*)+$","description":"JSON Pointer. Schema conservatively caps 64 Unicode characters; production permits at most 256 UTF-8 bytes."},"additionalProperties":{"type":["string","boolean","number","null"]}},"regex":{"type":"object","description":"Full-string RE2 patterns.","maxProperties":16,"propertyNames":{"type":"string","minLength":1,"maxLength":64,"pattern":"^(?:/(?:[^~/]|~[01])*)+$","description":"JSON Pointer. Schema conservatively caps 64 Unicode characters; production permits at most 256 UTF-8 bytes."},"additionalProperties":{"type":"string","maxLength":256,"description":"Full-string RE2 pattern. Schema conservatively caps 256 Unicode characters; production permits at most 1024 UTF-8 bytes and enforces RE2/program limits described on the constraint."}}},"anyOf":[{"required":["equals"]},{"required":["regex"]}],"allOf":[{"not":{"properties":{"equals":{"maxProperties":0},"regex":{"maxProperties":0}}}},{"anyOf":[{"properties":{"equals":{"maxProperties":0},"regex":{"maxProperties":16}}},{"properties":{"equals":{"maxProperties":1},"regex":{"maxProperties":15}}},{"properties":{"equals":{"maxProperties":2},"regex":{"maxProperties":14}}},{"properties":{"equals":{"maxProperties":3},"regex":{"maxProperties":13}}},{"properties":{"equals":{"maxProperties":4},"regex":{"maxProperties":12}}},{"properties":{"equals":{"maxProperties":5},"regex":{"maxProperties":11}}},{"properties":{"equals":{"maxProperties":6},"regex":{"maxProperties":10}}},{"properties":{"equals":{"maxProperties":7},"regex":{"maxProperties":9}}},{"properties":{"equals":{"maxProperties":8},"regex":{"maxProperties":8}}},{"properties":{"equals":{"maxProperties":9},"regex":{"maxProperties":7}}},{"properties":{"equals":{"maxProperties":10},"regex":{"maxProperties":6}}},{"properties":{"equals":{"maxProperties":11},"regex":{"maxProperties":5}}},{"properties":{"equals":{"maxProperties":12},"regex":{"maxProperties":4}}},{"properties":{"equals":{"maxProperties":13},"regex":{"maxProperties":3}}},{"properties":{"equals":{"maxProperties":14},"regex":{"maxProperties":2}}},{"properties":{"equals":{"maxProperties":15},"regex":{"maxProperties":1}}},{"properties":{"equals":{"maxProperties":16},"regex":{"maxProperties":0}}}]}]}]},"duration_seconds":{"anyOf":[{"type":"null"},{"type":"string","pattern":"^(?:[6-9][0-9]|[1-9][0-9]{2,5}|[12][0-9]{6})$"}]},"future_tools_acknowledged":{"type":"boolean"},"read_only":{"type":"boolean","description":"Restrict this server ALLOW to published readOnlyHint=true tools; omission is unrestricted."}}}}}`), false, false, false,
		json.RawMessage(`{"annotations":{"destructiveHint":false,"idempotentHint":false,"openWorldHint":false,"readOnlyHint":false,"title":"Create grant request"},"description":"Create or return an identical pending access request for the authenticated principal.","inputSchema":{"additionalProperties":false,"properties":{"policy":{"additionalProperties":false,"properties":{"constraint":{"anyOf":[{"type":"null"},{"additionalProperties":false,"properties":{"equals":{"additionalProperties":{"type":["string","boolean","number","null"]},"maxProperties":16,"minProperties":1,"propertyNames":{"description":"JSON Pointer. Schema conservatively caps 64 Unicode characters; production permits at most 256 UTF-8 bytes.","maxLength":64,"minLength":1,"pattern":"^(?:/(?:[^~/]|~[01])*)+$","type":"string"},"type":"object"}},"required":["equals"],"type":"object"},{"additionalProperties":false,"allOf":[{"not":{"properties":{"equals":{"maxProperties":0},"regex":{"maxProperties":0}}}},{"anyOf":[{"properties":{"equals":{"maxProperties":0},"regex":{"maxProperties":16}}},{"properties":{"equals":{"maxProperties":1},"regex":{"maxProperties":15}}},{"properties":{"equals":{"maxProperties":2},"regex":{"maxProperties":14}}},{"properties":{"equals":{"maxProperties":3},"regex":{"maxProperties":13}}},{"properties":{"equals":{"maxProperties":4},"regex":{"maxProperties":12}}},{"properties":{"equals":{"maxProperties":5},"regex":{"maxProperties":11}}},{"properties":{"equals":{"maxProperties":6},"regex":{"maxProperties":10}}},{"properties":{"equals":{"maxProperties":7},"regex":{"maxProperties":9}}},{"properties":{"equals":{"maxProperties":8},"regex":{"maxProperties":8}}},{"properties":{"equals":{"maxProperties":9},"regex":{"maxProperties":7}}},{"properties":{"equals":{"maxProperties":10},"regex":{"maxProperties":6}}},{"properties":{"equals":{"maxProperties":11},"regex":{"maxProperties":5}}},{"properties":{"equals":{"maxProperties":12},"regex":{"maxProperties":4}}},{"properties":{"equals":{"maxProperties":13},"regex":{"maxProperties":3}}},{"properties":{"equals":{"maxProperties":14},"regex":{"maxProperties":2}}},{"properties":{"equals":{"maxProperties":15},"regex":{"maxProperties":1}}},{"properties":{"equals":{"maxProperties":16},"regex":{"maxProperties":0}}}]}],"anyOf":[{"required":["equals"]},{"required":["regex"]}],"properties":{"equals":{"additionalProperties":{"type":["string","boolean","number","null"]},"maxProperties":16,"propertyNames":{"description":"JSON Pointer. Schema conservatively caps 64 Unicode characters; production permits at most 256 UTF-8 bytes.","maxLength":64,"minLength":1,"pattern":"^(?:/(?:[^~/]|~[01])*)+$","type":"string"},"type":"object"},"regex":{"additionalProperties":{"description":"Full-string RE2 pattern. Schema conservatively caps 256 Unicode characters; production permits at most 1024 UTF-8 bytes and enforces RE2/program limits described on the constraint.","maxLength":256,"type":"string"},"description":"Full-string RE2 patterns.","maxProperties":16,"propertyNames":{"description":"JSON Pointer. Schema conservatively caps 64 Unicode characters; production permits at most 256 UTF-8 bytes.","maxLength":64,"minLength":1,"pattern":"^(?:/(?:[^~/]|~[01])*)+$","type":"string"},"type":"object"},"version":{"const":2}},"required":["version"],"type":"object"}],"description":"Null, permanent v1 equality, or v2 equality and full-string RE2 constraint. The production compiler additionally enforces an 8192-byte aggregate, RFC 6901 escapes, RE2 validity, at most 4096 instructions per pattern, and at most 256 instructions across regex atoms."},"duration_seconds":{"anyOf":[{"type":"null"},{"pattern":"^(?:[6-9][0-9]|[1-9][0-9]{2,5}|[12][0-9]{6})$","type":"string"}]},"future_tools_acknowledged":{"type":"boolean"},"read_only":{"description":"Restrict this server ALLOW to published readOnlyHint=true tools; omission is unrestricted.","type":"boolean"},"scope":{"enum":["tool","server"]},"target":{"maxLength":128,"minLength":1,"type":"string"}},"required":["scope","target","constraint","duration_seconds","future_tools_acknowledged"],"type":"object"}},"required":["policy"],"type":"object"},"name":"create_grant_request","title":"Create grant request"}`),
		"705b412acce6b251469a3affc3ccf8cee447456e82ec3f2e801893ce877e0772",
	),
	newSyntheticTool(
