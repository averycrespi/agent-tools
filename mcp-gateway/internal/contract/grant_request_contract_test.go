...
func TestSelfServiceSyntheticDescriptorsAreExactAndPinned(t *testing.T) {
	...
	for index, want := range expected {
		...
		require.Equal(t, "3", tool.CatalogRevision)
