...
var controlPlaneCapabilities = []ControlPlaneCapability{
	...
	{ID: "admin-credential-create", Operation: "Admin credential create", WebControl: "System / Admin credentials / Create", CLIUses: []string{"admin-credential create --file PATH [--secret-output NEW_PATH]"}, Mechanics: "one-time sink; inherited body"},
	...
	{ID: "server-update", Operation: "Server update", WebControl: "server detail / Edit", CLIUses: []string{"server update ID --etag ETAG --file PATH"}, Mechanics: "nonempty patch; ETag"},
	{ID: "server-delete", Operation: "Server delete", WebControl: "server detail / Delete", CLIUses: []string{"server delete ID --etag ETAG"}, Mechanics: "exact {}; typed namespace/--yes; ETag"},
	...
	{ID: "operation-start", Operation: "Explicit operation", WebControl: "server detail action", CLIUses: []string{"server operation start ID --etag ETAG --file PATH"}, Mechanics: "closed body; ETag; idempotency key"},
	{ID: "server-credential", Operation: "Credential replacement", WebControl: "server detail / Credentials", CLIUses: []string{"server credential replace ID --etag ETAG --file PATH"}, Mechanics: "write-only; ETag; confirmation; no replay"},
	...
	{ID: "auth-flow-start", Operation: "Auth-flow start", WebControl: "server detail / OAuth / Authorize", CLIUses: []string{"server auth-flow start ID --etag ETAG [--open]"}, Mechanics: "exact {}; ETag; one-time URL sink"},
	...
	{ID: "principal-create", Operation: "Principal create", WebControl: "Access / Principals / Create", CLIUses: []string{"principal create --file PATH"}, Mechanics: "inherited body"},
	{ID: "principal-update", Operation: "Principal update", WebControl: "principal detail / Edit", CLIUses: []string{"principal update ID --etag ETAG --file PATH"}, Mechanics: "patch; ETag; confirmation"},
	{ID: "principal-credential-issue", Operation: "Agent credential issue", WebControl: "principal detail / Credential", CLIUses: []string{"principal credential issue ID --etag ETAG [--secret-output NEW_PATH]"}, Mechanics: "exact {}; ETag; one-time sink; confirmation"},
	{ID: "principal-credential-revoke", Operation: "Agent credential revoke", WebControl: "principal detail / Credential", CLIUses: []string{"principal credential revoke ID --etag ETAG"}, Mechanics: "exact {}; ETag; confirmation"},
	...
	{ID: "grant-create", Operation: "Grant create", WebControl: "Access / Grants / Create", CLIUses: []string{"grant create --file PATH"}, Mechanics: "complete body"},
	...
	{ID: "grant-request-approve", Operation: "Grant-request approve", WebControl: "request detail / Review", CLIUses: []string{"grant-request approve REQUEST_ID --etag ETAG --file PATH"}, Mechanics: "narrowing; ETag; confirmation; no replay"},
	{ID: "grant-request-reject", Operation: "Grant-request reject", WebControl: "request detail / Review", CLIUses: []string{"grant-request reject REQUEST_ID --etag ETAG --file PATH"}, Mechanics: "reason; ETag; confirmation; no replay"},
...
func ControlPlaneLifecycleManifest() []ControlPlaneCapability {
	return []ControlPlaneCapability{
		...
		{ID: "cli-admin-reset", Operation: "Stopped admin reset", CLIUses: []string{"admin-reset"}, Mechanics: "offline compatibility", CLIScenario: "cli.admin-reset"},
