...
func TestServerResourceComposesDurableAndProcessLocalActiveCatalog(t *testing.T) {
	...
	activeRevision := "7"
	activeCatalog := &fakeActiveCatalog{status: catalog.ActiveStatus{State: contract.ActiveCatalogCurrent, Revision: &activeRevision, ToolCount: 3}}
