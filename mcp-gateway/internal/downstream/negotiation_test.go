...
func TestNegotiatorUsesOnlyClosedFallbackEvidenceAndFreshTransport(t *testing.T) {
	tests := []struct {
		...
		{name: "Python SDK unsupported version JSON", response: staticResponse(400, "application/json", `{"jsonrpc":"2.0","id":"server-error","error":{"code":-32600,"message":"Bad Request: Unsupported protocol version: 2026-07-28. Supported versions: 2024-11-05, 2025-03-26, 2025-06-18, 2025-11-25"}}`), allowed: true},
		{name: "Python SDK lacks supported legacy", response: staticResponse(400, "application/json", `{"jsonrpc":"2.0","id":"server-error","error":{"code":-32600,"message":"Bad Request: Unsupported protocol version: 2026-07-28. Supported versions: 2025-06-18"}}`)},
		{name: "Python SDK includes unknown version", response: staticResponse(400, "application/json", `{"jsonrpc":"2.0","id":"server-error","error":{"code":-32600,"message":"Bad Request: Unsupported protocol version: 2026-07-28. Supported versions: 2025-11-25, 2026-01-01"}}`)},
