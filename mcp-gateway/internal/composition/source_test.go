...
func TestProductionRootUsesConcreteNativeCompositionAndDenyAllIngress(t *testing.T) {
	...
	for _, required := range []string{
		"newComposition: composition.New", "newComposition(composition.Options{", "authorizationRepository := runtime.Authorization()", "Principals:     authorizationRepository", "activeCatalog := runtime.ActiveCatalog()",
