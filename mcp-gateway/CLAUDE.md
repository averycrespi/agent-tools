...
- Follow the [table conventions](docs/design/administrative-control-plane.md#table-conventions) for activity/resource column order, semantic width roles, identity, vocabulary, and narrow layouts; see [table implementation](docs/maintainers/frontend-development.md#table-implementation) for the shared component contract.
