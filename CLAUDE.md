...
For the two-process live-reload workflow, follow the [MCP Gateway frontend development guide](agent-gateway/docs/maintainers/frontend-development.md). For Gateway evidence tiers, exact-revision acceptance, external qualification, and report adoption, follow the [release verification guide](agent-gateway/docs/maintainers/release-verification.md).
