...
func auditMutationTarget(request *http.Request, installationID string) (string, string, contract.AuditTarget, bool) {
	...
	selected, ok := map[string]mutation{
		"POST /api/v2/http/grants":                                {"http_grant", "create", "installation", ""},
		"PATCH /api/v2/http/grants/{id}":                          {"http_grant", "update", "http_grant", "{id}"},
		"DELETE /api/v2/http/grants/{id}":                         {"http_grant", "delete", "http_grant", "{id}"},
		"PATCH /api/v2/http/defaults/{id}":                        {"http_default", "update", "http_default", "{id}"},
		...
		"DELETE /api/v2/admin-credentials/{id}":                   {"admin_credential", "revoke", "admin_credential", "{id}"},
		"POST /api/v2/admin-credentials/{id}/rotation-completion": {"admin_credential", "rotate", "admin_credential", "{id}"},
		"POST /api/v2/backups":                                    {"backup", "create", "installation", ""},
		"DELETE /api/v2/backups/{id}":                             {"backup", "delete", "backup", "{id}"},
		"POST /api/v2/mcp/servers":                                {"server", "create", "installation", ""},
		"PATCH /api/v2/mcp/servers/{id}":                          {"server", "update", "server", "{id}"},
		"DELETE /api/v2/mcp/servers/{id}":                         {"server", "delete", "server", "{id}"},
		"POST /api/v2/mcp/servers/{id}/operations":                {"operation", "request", "server", "{id}"},
		"POST /api/v2/mcp/servers/{id}/credential-replacements":   {"server_credential", "replace", "server", "{id}"},
		"POST /api/v2/mcp/servers/{id}/oauth-flows":               {"oauth", "create", "server", "{id}"},
		"DELETE /api/v2/mcp/servers/{id}/oauth-flows/{flow_id}":   {"oauth", "cancel", "auth_flow", "{flow_id}"},
		"POST /api/v2/principals":                                 {"principal", "create", "installation", ""},
