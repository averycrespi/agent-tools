...
func AuditTargetTypes() []string {
	return []string{"installation", "admin_credential", "backup", "server", "operation", "auth_flow", "principal", "agent_credential", "grant", "grant_request", "descriptor", "http_credential"}
}
