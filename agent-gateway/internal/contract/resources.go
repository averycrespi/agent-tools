...
var resourceMechanics = []ResourceMechanic{
	...
	{Pattern: "/api/v2/admin-credentials", Method: "GET", RequestSchema: "AdminCredentialListQuery", SuccessSchema: "Page<AdminCredential>", SuccessStatuses: []int{200}, Cursor: true},
	{Pattern: "/api/v2/admin-credentials", Method: "POST", RequestSchema: "AdminCredentialCreate", SuccessSchema: "CreatedAdminCredential", SuccessStatuses: []int{201}, OptionalPrecondition: true, ETag: true},
	{Pattern: "/api/v2/admin-credentials/{id}", Method: "DELETE"},
	{Pattern: "/api/v2/admin-credentials/{id}", Method: "GET"},
	{Pattern: "/api/v2/system-status", Method: "GET"},
	{Pattern: "/api/v2/backups", Method: "GET", RequestSchema: "BackupListQuery", SuccessSchema: "Page<Backup>", SuccessStatuses: []int{200}, Cursor: true},
	{Pattern: "/api/v2/backups", Method: "POST", Idempotency: true},
	{Pattern: "/api/v2/backups/{id}", Method: "DELETE"},
	{Pattern: "/api/v2/backups/{id}", Method: "GET"},
	{Pattern: "/api/v2/events", Method: "GET"},
	...
	{Pattern: "/api/v2/mcp/grants", Method: "GET", RequestSchema: "GrantListQuery", SuccessSchema: "QueryPage<GrantTableItem>", SuccessStatuses: []int{200}, Cursor: true},
	{Pattern: "/api/v2/mcp/grants", Method: "POST", RequestSchema: "GrantCreate", SuccessSchema: "Grant", SuccessStatuses: []int{201}, ETag: true},
	{Pattern: "/api/v2/mcp/grants/{id}", Method: "GET", RequestSchema: "None", SuccessSchema: "Grant", SuccessStatuses: []int{200}, ETag: true},
	{Pattern: "/api/v2/mcp/grants/{id}", Method: "PATCH", RequestSchema: "GrantPatch", SuccessSchema: "Grant", SuccessStatuses: []int{200}, Precondition: true, ETag: true},
	{Pattern: "/api/v2/mcp/grants/{id}", Method: "DELETE", RequestSchema: "None", SuccessSchema: "Empty", SuccessStatuses: []int{204}},
	{Pattern: "/api/v2/mcp/grant-constraints/validate", Method: "POST", RequestSchema: "GrantConstraintValidation", SuccessSchema: "GrantConstraintValidationResult", SuccessStatuses: []int{200}},
	...
	{Pattern: "/api/v2/admin-sessions/current", Method: "POST", RequestSchema: "EmptyObject", SuccessSchema: "AdminSessionBootstrap", SuccessStatuses: []int{200}},
