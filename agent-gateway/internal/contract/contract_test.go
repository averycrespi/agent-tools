...
func TestMediaTypesAndApprovedSecretSinksAreClosed(t *testing.T) {
	...
	require.Equal(t, []SecretSink{SecretSinkBrowserOneTimeDisplay, SecretSinkUserInitiatedClipboard}, ApprovedSecretSinks()[8:10], "S6 browser sinks retain their positions")
	require.Equal(t, []SecretSink{SecretSinkHTTPProxyEnvironment}, ApprovedSecretSinks()[10:])
