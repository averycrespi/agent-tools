...
var documentationCommandFamilies = []DocumentationCommandFamily{
	...
	{ID: "docs.command.grant", CommandPath: "grant", CanonicalOwner: "docs/operators/access-control.md", HelpInvocation: "agent-gateway grant --help"},
	{ID: "docs.command.grant.request", CommandPath: "grant-request", CanonicalOwner: "docs/operators/access-control.md", HelpInvocation: "agent-gateway grant-request --help"},
