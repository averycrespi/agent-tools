...
var documentationCommandFamilies = []DocumentationCommandFamily{
	...
	{ID: "docs.command.initialize", CommandPath: "init", CanonicalOwner: "docs/operators/administration.md", HelpInvocation: "agent-gateway init --help"},
	...
	{ID: "docs.command.principal", CommandPath: "agent", CanonicalOwner: "docs/operators/access-control.md", HelpInvocation: "agent-gateway agent --help"},
	{ID: "docs.command.storage", CommandPath: "maintenance", CanonicalOwner: "docs/operators/backup-and-recovery.md", HelpInvocation: "agent-gateway maintenance --help"},
	...
	{ID: "docs.command.status", CommandPath: "doctor", CanonicalOwner: "docs/operators/administration.md", HelpInvocation: "agent-gateway doctor --help"},
}

var documentationSecurityContracts = []DocumentationSecurityContract{
	{ID: "docs.security.admin.authority", CanonicalOwner: "docs/operators/administration.md", HelpFamilies: []string{"init", "admin credential"}},
	{ID: "docs.security.local.control", CanonicalOwner: "docs/operators/administration.md", HelpFamilies: []string{"serve", "doctor"}},
	{ID: "docs.security.one.time.sinks", CanonicalOwner: "docs/operators/administration.md", HelpFamilies: []string{"admin credential", "agent", "mcp server"}},
	...
	{ID: "docs.security.principal.policy", CanonicalOwner: "docs/operators/access-control.md", HelpFamilies: []string{"agent", "mcp grant", "mcp grant-request"}},
	...
	{ID: "docs.security.backup.recovery", CanonicalOwner: "docs/operators/backup-and-recovery.md", HelpFamilies: []string{"maintenance", "backup"}},
