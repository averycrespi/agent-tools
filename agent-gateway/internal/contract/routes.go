...
var routes = []Route{
	...
	{Pattern: "/api/v2/mcp/invocations", Methods: []string{"GET"}, Authority: AuthorityAdmin},
	{Pattern: "/api/v2/mcp/invocations/{id}", Methods: []string{"GET"}, Authority: AuthorityAdmin},
