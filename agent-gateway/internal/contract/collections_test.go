...
func TestV2CollectionContractsCoverEveryCursorResource(t *testing.T) {
	...
	require.Equal(t, map[string]bool{"/api/v2/http/credentials": true, "/api/v2/principals": true, "/api/v2/mcp/grants": true, "/api/v2/mcp/grant-requests": true, "/api/v2/mcp/servers/{id}/operations": true}, counts)
