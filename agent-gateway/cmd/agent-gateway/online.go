...
func onlineLongDescription(spec onlineCommandSpec) string {
	...
	case "http credential get", "http credential list":
		return spec.Short + ". Show scope and metadata, never stored secrets."
	case "http credential delete":
		return spec.Short + ". Only unreferenced credentials can be deleted."
	case "mcp invocation get":
		return spec.Short + ". JSON includes retained redacted arguments and execution evidence."
	case "agent create":
...
var onlineGroupDescriptions = map[string]string{
	...
	"http credential":       "Manage HTTP credentials",
	...
	"mcp server credential": "Manage server credentials",
	"mcp server auth-flow":  "Manage server OAuth authorization",
	"mcp server descriptor": "View discovered server tools",
	"mcp catalog":           "View published Gateway tools",
	"agent":                 "Manage agents",
	"agent credential":      "Manage agent credentials",
	"mcp grant":             "Manage MCP access grants",
	"mcp grant-request":     "Manage MCP access requests",
	"mcp invocation":        "View MCP invocation history",
...
var onlineLeafDescriptions = map[string]string{
	...
	"http traffic get ID":                                 "Get an HTTP traffic record",
	"http grant list":                                     "List HTTP access grants",
	"http grant get ID":                                   "Get an HTTP access grant",
	"http grant create --file PATH":                       "Create an HTTP access grant",
	"http grant update ID --file PATH [--etag ETAG]":      "Update an HTTP access grant",
	"http grant delete ID [--etag ETAG]":                  "Delete an HTTP access grant",
	"http default get ID":                                 "Get an agent's default HTTP policy",
	"http default update ID --file PATH [--etag ETAG]":    "Update an agent's default HTTP policy",
	"http test-access --file PATH":                        "Preview HTTP access",
	"http credential list":                                "List HTTP credentials",
	"http credential get ID":                              "Get an HTTP credential",
	"http credential create --file PATH":                  "Create an HTTP credential",
	...
	"mcp server create --file PATH": "Create an MCP server",
	"mcp server update ID [--etag ETAG] [--display-name NAME] [--enable|--disable] [--file PATH]": "Update an MCP server",
	"mcp server delete ID [--etag ETAG]":                         "Delete an MCP server",
	"mcp server operation list ID":                               "List operations for a server",
	"mcp server operation get ID OPERATION_ID":                   "Get a server operation",
	"mcp server operation start ID --kind KIND [--etag ETAG]":    "Start a server operation",
	...
	"mcp server auth-flow get ID FLOW_ID":                        "Get a server OAuth flow",
	...
	"mcp server descriptor get ID TOOL_ID":                       "Get a discovered server tool",
	"mcp catalog list":                                           "List published Gateway tools",
	"agent list":                                                 "List agents",
	"agent get ID":                                               "Get an agent",
	"agent create --display-name NAME --visibility VISIBILITY":   "Create an agent",
	"agent update ID [--etag ETAG] [--display-name NAME] [--visibility VISIBILITY] [--state STATE] [--http-default POLICY]": "Update an agent",
	"agent credential issue ID [--etag ETAG] [--secret-output NEW_PATH]":                                                    "Issue an agent credential",
	"agent credential rotate ID [--etag ETAG] [--secret-output NEW_PATH]":                                                   "Rotate an agent credential",
	"agent credential revoke ID [--etag ETAG]":                                                                              "Revoke an agent credential",
	"mcp grant list":   "List MCP access grants",
	"mcp grant get ID": "Get an MCP access grant",
	"mcp grant create --principal-id ID --effect EFFECT --server-id ID [--description TEXT] [--upstream-name NAME] [--expires-at RFC3339] [--read-only] [--file PATH]": "Create an MCP access grant",
	"mcp grant update ID --description TEXT [--etag ETAG]": "Update an MCP grant description",
	"mcp grant delete ID":              "Delete an MCP access grant",
	"mcp grant-request list":           "List agent grant requests",
	"mcp grant-request get REQUEST_ID": "Get an agent grant request",
	...
	"mcp invocation get INVOCATION_ID": "Get an MCP invocation",
}
