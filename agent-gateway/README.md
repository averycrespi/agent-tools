...
- [HTTP administration](docs/operators/administration.md#http-traffic-history) and [stopped CA commands](docs/operators/backup-and-recovery.md#stopped-interception-ca-commands) are available. The proxy remains unselected; no trust is installed.
