...
if (
  ...
  packageJSON.scripts?.["ui:verify-generated"] !==
    "node agent-gateway/web/scripts/verify-generated.mjs"
)
...
const webRoot = join(repositoryRoot, "agent-gateway/web");
...
const staticRoot = join(repositoryRoot, "agent-gateway/internal/api/static");
