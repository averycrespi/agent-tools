...
common time/class pair; the full cutover must also carry validated diagnostics
through terminal persistence. Earlier experimental traffic schemas are rejected,
