...
| Legacy roots, service labels/plists/process basenames in `internal/paths`, `internal/installation`, `scripts/launchd-agent.py` and fixtures | Safety refusal, single-owner proof, tombstone recognition and explicit stopped migration; custom selections remain supported                       |
