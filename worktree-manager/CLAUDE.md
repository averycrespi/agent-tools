...
- File copy and setup scripts run only during initial worktree creation; missing configured files/scripts are skipped, but copy failures for existing files and failures from existing setup scripts must propagate as errors
