...
func TestDashboardUIExposesRunDetailAndLogsExplorer(t *testing.T) {
	...
	for _, want := range []string{"/dashboard/api/runs/", "/logs", "Workflow Runs", "Search workflow runs", "inputs:", "Inputs", "Supervisor logs", "Pi Orchestrator", "favicon.svg", "location.hash", "setTab(state.tab)"} {
