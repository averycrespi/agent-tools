...
- Host username, UID, and home directory are injected into the template; GID is not currently injected, so group-write behavior depends on provisioning or host permissions
