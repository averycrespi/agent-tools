...
func init() {
	...
	rootCmd.AddCommand(configCmd, runCmd, listCmd, statusCmd, logsCmd, eventsCmd, attachCmd, steerCmd, followupCmd, stopCmd, rmCmd, tokenCmd, dashboardCmd, supervisorCmd)
}
