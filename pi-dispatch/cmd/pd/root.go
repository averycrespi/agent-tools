...
func init() {
	...
	rootCmd.AddCommand(configCmd, runCmd, listCmd, statusCmd, waitCmd, logsCmd, steerCmd, followupCmd, stopCmd, cleanupCmd, rmCmd, tokenCmd, dashboardCmd, supervisorCmd)
}
