...
SELECT
    ...
    r.id, r.task_id, r.attempt, r.supervisor_pid, r.pi_session_file, r.status, r.started_at, r.ended_at, r.exit_code, r.error_message, r.agent_options_json, r.pi_argv_json, r.control_socket_path, r.stdout_log_path, r.stderr_log_path, r.pi_events_path
FROM tasks t
